...
class lineBarConfig {
  ...
  template() {
    let html = '<div class="configSection">' +
      '<div>' +
      '<span class="closeIcon"></span><span class="titleName">折柱混合图设置</span>' +
      ...
      '<div>' +
      '<span>方向</span>' +
      '<label><input type="radio" name="orientation" value="vertical"' +
      'class="location" checked/>纵向</label>' +
      '<label><input type="radio" name="orientation" value="horizontal"' +
      'class="location"/>横向</label>' +
      '</div>' +
      '<div>' +
      '<span>动效</span>' +
      ...
      '<label><input type="radio" name="legendPosition" value="bottom" checked/>下</label>' +
