...
class BarConfig extends BaseConfig {
  ...
  template() {
    let html = '<h3>图表属性</h3>' +
      ...
      '<div>' +
      '<span>方向</span>' +
      '<label><input type="radio" name="orientation" value="vertical" checked/>纵向</label>' +
      '<label><input type="radio" name="orientation" value="horizontal"/>横向</label>' +
      '</div>' +
      '<div>' +
      '<span>动效</span>' +
      ...
      '<div>' +
      '<span>显示网络线</span>' +
      '<label><input type="radio" name="orthoAxisGrid baseAxisGrid" value="true"/>是</label>' +
      '<label>' +
      '<input type="radio" name="orthoAxisGrid baseAxisGrid"' +
      'value="horizontal" checked/>横向</label>' +
      '<label><input type="radio" name="orthoAxisGrid baseAxisGrid"' +
      'value="vertical"/>纵向</label>' +
      '<label><input type="radio" name="orthoAxisGrid baseAxisGrid" value="false"/>否</label>' +
      '</div>' +
      '<div>' +
      '<span>堆叠显示</span>' +
