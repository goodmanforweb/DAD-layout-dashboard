...
class LineConfig {
  ...
  template() {
    let html = '<div class="configSection">' +
      '<div>' +
      '<span class="closeIcon"></span><span class="titleName">折线图设置</span>' +
      ...
      '<div>' +
      '<span>标题位置</span>' +
      '<label><input type="radio" name="titleLoc" value="left"/>左</label>' +
      ...
      '<div>' +
      '<span>方向</span>' +
      '<label><input type="radio" name="orientation" class="location"' +
      ...
      '<div>' +
      '<span>折线风格</span>' +
      '<label><input type="radio" name="line_interpolate" value="linear" checked/>折线</label>' +
      '<label><input type="radio" name="line_interpolate" value="monotone"/>无棱角</label>' +
      '<label><input type="radio" name="line_interpolate" value="basis"/>平滑</label>' +
      '<label><input type="radio" name="line_interpolate" value="cardinal"/>标准</label>' +
      '</div>' +
      '<div>' +
      '<span>插值</span>' +
      '<label><input type="radio" name="nullInterpolationMode" value="none" checked/>无</label>' +
      '<label><input type="radio" name="nullInterpolationMode" value="zero"/>零</label>' +
      '<label><input type="radio" name="nullInterpolationMode" value="linear"/>线性</label>' +
      '</div>' +
      '<div>' +
      '<span>圆点显示</span>' +
      '<label><input type="radio" name="dotsVisible" value="true"/>是</label>' +
      '<label><input type="radio" name="dotsVisible" value="false" checked/>否</label>' +
      '</div>' +
      '<div>' +
      '<span>面积显示</span>' +
      '<label><input type="radio" name="areasVisible" value="true"/>是</label>' +
      '<label><input type="radio" name="areasVisible" value="false" checked/>否</label>' +
      '</div>' +
      '<div>' +
      '<span>堆叠显示</span>' +
